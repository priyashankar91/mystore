...
<table align="center" >
		<tr>
			<%try {
				...
				<td  align="center" style="border-collapse:collapse;border:1px solid #000000; border-radius:10px;" bgcolor="white" width="200" height="200">	
				...
				<%	out.print("<input type=\"hidden\" name=\"ProdName\" value=\""+ProdList.get(i).getPid()+"\" readonly>");
					out.print("Rs. "+ProdList.get(i).getPcost()+"<br>"); 
				%>
					<input type="submit" name="Product Page" value="Product Page"></input>
				<% 	
			}
